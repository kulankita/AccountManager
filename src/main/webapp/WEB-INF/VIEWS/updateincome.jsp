...
<header>
	...
	<div class="container">
		<h1>Edit Income Details</h1>
		 <form action="lmn" method="post">
                <label for="categoryId">Income ID:</label>
				...
				<%
				Income e = (Income)request.getAttribute("a");
				if(e != null) {      
            %>		 
						 
		<form method="post" action="lmn2">
